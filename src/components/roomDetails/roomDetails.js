  ...
  function Rating({ score }) {
    ...
    for (let i = 0; i < 5; i++) {
      if (i < score) {
        ...
        stars.push(
          <FontAwesomeIcon className="withoutRating" key={i} icon={fullStar} />
        );
      }
    }
            ...
            <div className="room__info">
              <div className="room__titleUnderTitleTag">
                ...
                <ul>
                  {roomDetails.tags.map((tag) => (
                    <li className="room__tag" key={tag}>
                      {tag}
                    </li>
                  ))}
                </ul>
              ...
              <div className="ratingAndName">
                ...
                <div className="nameAndPicture">
                  <p className="nameAndPicture__name">
                    {roomDetails.host.name}
                  </p>
                  <img
                    className="nameAndPicture__picture"
                    src={roomDetails.host.picture}
                    alt=""
                  ></img>
                  <div></div>
                </div>
